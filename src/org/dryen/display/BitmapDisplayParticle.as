package org.dryen.display
{
	...
	import org.dryen.display.particles.BitmapDataParticle;
	
	public class BitmapDisplayParticle extends Bitmap
	{
		...
		private var _particlesList:Vector.<BitmapDataParticle>;
		private var _particlesListLength:int;
		
		public function BitmapDisplayParticle(particles:Vector.<BitmapDataParticle> = null, transparent:Boolean = true, bgColor:uint = 0xFF0000, pixelSnapping:String = "auto", smoothing:Boolean = false)
		{
			...
			if(particles)
			{
				_particlesList = particles;
				_particlesListLength = _particlesList.length;
			}
		...
		public function render(e:Event=null):void
		{
			...
			for(i = 0; i< _particlesListLength; ++i)
			{
				_particlesList[i].update();
				_render_bmpd.copyPixels(_particlesList[i].bitmapData, _particlesList[i].rect, _particlesList[i].position, null, null, true);
			}
		...
		public function set particlesList(value:Vector.<BitmapDataParticle>):void
		{
